      ...
      <section className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-gradient-to-r from-blue-50 to-emerald-50 dark:from-gray-800 dark:to-gray-800 p-8 rounded-2xl border border-blue-100 dark:border-gray-700">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 mb-4">
            Welcome to the Currency Strength Meter—your free, real-time tool for identifying the strongest and weakest forex currencies. Whether you're a beginner just starting your forex journey or an experienced trader looking for a professional-grade analysis tool, our meter provides institutional-quality insights at no cost.
          </p>
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            Instead of analyzing dozens of individual currency pairs manually, our advanced algorithm calculates the relative strength of eight major currencies (USD, EUR, GBP, JPY, CAD, CHF, AUD, NZD) across all 28 major forex pairs in real-time. This gives you a clear, actionable market overview in a single glance.
          </p>
          <div className="grid md:grid-cols-3 gap-4 mt-6">
            <div className="bg-white dark:bg-gray-700 p-4 rounded-lg">
              <p className="font-semibold text-blue-600 dark:text-blue-400 mb-2">✅ 100% Free</p>
              <p className="text-sm text-gray-600 dark:text-gray-400">No hidden fees, subscriptions, or premium tiers. Use our tool completely free.</p>
            </div>
            <div className="bg-white dark:bg-gray-700 p-4 rounded-lg">
              <p className="font-semibold text-emerald-600 dark:text-emerald-400 mb-2">⚡ Real-Time Updates</p>
              <p className="text-sm text-gray-600 dark:text-gray-400">Data refreshes every few seconds to reflect the latest market conditions.</p>
            </div>
            <div className="bg-white dark:bg-gray-700 p-4 rounded-lg">
              <p className="font-semibold text-purple-600 dark:text-purple-400 mb-2">🎯 Beginner-Friendly</p>
              <p className="text-sm text-gray-600 dark:text-gray-400">Designed for traders of all levels with a simple, intuitive interface.</p>
            </div>
          </div>
          <div className="mt-6 flex gap-4 flex-wrap">
            <Link href="/getting-started" className="bg-blue-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-blue-700 transition">
              Get Started
            </Link>
            <Link href="/blog" className="border border-blue-600 text-blue-600 dark:text-blue-400 px-6 py-2 rounded-lg font-semibold hover:bg-blue-50 dark:hover:bg-gray-700 transition">
              Learn More
            </Link>
          </div>
        </div>
