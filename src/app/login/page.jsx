  ...
  async function handleSubmit(e) {
    ...
    if (signInError) {
      ...
      if (msg.includes("email not confirmed")) {
        ...
        // Error path: reset loading state so user can interact
        setLoading(false);
      ...
      // Error path: reset loading state
      setLoading(false);
    ...
    // Success path: DO NOT call setLoading(false) here.
    // Keep loading true so the button stays disabled/processing until the target route loads.
